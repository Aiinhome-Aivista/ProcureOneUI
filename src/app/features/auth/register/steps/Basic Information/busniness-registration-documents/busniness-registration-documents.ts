...
@Component({
  selector: 'app-busniness-registration-documents',
  imports: [CommonModule, ReactiveFormsModule],
  standalone: true,
  templateUrl: './busniness-registration-documents.html',
  styleUrl: './busniness-registration-documents.css',
})
export class BusninessRegistrationDocuments {
 data = input<any>({});
